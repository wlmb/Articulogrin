...
\notaL{Cambiar figura a una adecuada}
...
\begin{figure}
  ...
  \caption{\notaL{Está bonita la figura, pero tiene errores. La
    ...
    arranged in the sequence $(HL)_NHH(HL)_N$. Both the index of
...
positioned. In the figure we indicate three points with $x$ coordinate

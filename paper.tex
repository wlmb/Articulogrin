...
\begin{document}
\shorttitle{Model for PS Structures with a Lateral Gradient}
\shortauthors{Ospina-Delacruz et al.}
\title[mode=title]{Model for Porous Silicon Structures with a Lateral Gradient}
\author[1]{C. A. Ospina-Delacruz}[orcid=0000-0000-0000-0000]
...
\begin{keywords}
  Porous Silicon\sep GRIN \sep Reflectance Spectra.
\end{keywords}
...
more complex novel non-homogenous devices with lateral gradients which can be used
...
\begin{figure}
  \centering
  \includegraphics[width=.8\textwidth]{j_Ivsxy.png}
  \includegraphics[width=.6\textwidth]{j_Ivsx.png}
...
V. Castillo-Gallardo for useful discussions. VA acknowledges support

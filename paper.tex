...
the $p$ vs. $j$ and $v$ vs. $j$ calibration curves.  Thickness was additionally viewed through scanning electron microscopy. We corroborated
...
on gold electrodes have also been obtained\cite{wang2019fabrication}. \notaL{Is this Shannon a big shot, or
  why should we name him?; R : Eliminated the name}
...
perpendicular to the silicon wafer (anode)\notaL{Is it clear what
  is asymmetric?}, produces porous
...
for reproducible device performance, we
...
electrical contact to a brass plate\notaC{ laton.}\notaL{Porqué
  ...
  aleación de cobre y plata? Era un alambre o una placa?  CRISTIAN :  POR FAVOR COLOCAS lo que usaste.  }
...
\label{sec:refl-meas}
We measured absolute reflectance at different positions over our
samples using Universal reflectance accessory  equipped {\em Perkin Elmer Lambda 950}
UV-Vis-NIR spectrophotometer, with a rectangular spot size of
$0.7\text{mm}\times2.0\text{mm}$, a slit width of $0.6\text{mm}$ in
a wavelength range from $300\text{nm}$ to
$1400\text{nm}$.\notaL{Vivechna: puedes checar si así se reportan estos parámetros? CHANGED}
...
IN111119. VA acknowledges support from CONACyT Basic Sciences project A-S1 30393, PRODEP and ICF. \notaL{Cristian debe agradecer a conacyt y faltan

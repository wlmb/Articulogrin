...
\begin{abstract}
  ...
  refractive indices and their thicknesses. Simple fabrication of such
  ...
  In this work, we propose a simple analytical model based on a simple
  ...
  different samples. Thus, from measurements on only one system, full
  calibration curves may be obtained and used to predict, design, and
  fabricate more complex novel non-homogenous multilayered devices with lateral
  gradients which can be used for manifold applications.

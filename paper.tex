...
usefulness. \notaL{I believe the examples below are unrelated to GRIN,
  thats why I added this remark.} As an example, the
...
In addition the same group \cite{krueger2018electrochemical} used porous silicon 1D GRIN structure infiltrated with polymer to synthesize flat microns arrays.

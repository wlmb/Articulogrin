...
\begin{document}
\shorttitle{Model for the ECh Sythesis of PS Structures with a Lateral Gradient}
\shortauthors{Ospina-Delacruz et al.}
\title[mode=title]{Model for the Electrochemical Synthesis of Porous
  Silicon Structures with a Lateral Gradient}

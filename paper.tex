...
$0.14\,\text{cm}$. Thus, we may expect our formula \eqref{Eq:J}
...
sample. Here, we defined $x'_n$ as the distance to the sealing o-ring,
which differed by $0.14\,\text{cm}$ from the corresponding distance
$x_n$ to the wall of the cell.
...
for calibration variations among spectra. ****AQUIVOY***

...
the $p$ vs. $j$ and $v$ vs. $j$ calibration curves.
\notaV{Thickness was additionally viewed through scanning electron microscopy}. We corroborated
...
usefulness. \notaL{I believe the examples below are unrelated to GRIN,
  thats why I added the previous remark.} \notaV{Response :
ALL the examples are related to GRIN} As an example, the
...
\notaV{ The idea
here was to mention the usefulness of GRIN in portion
size determination followed by its delivery through the variation of pH ;
If you find this comment too way off, further applicability of protein
size determination in drug delivery application can
 be removed "ADDITIONALLY.....applications" }
...
infiltration of TiO2  by \notaV{Atomic Layer Deposition} (ALD) \notaL{What is this acronym?}
...
the current density at any point over the GRIN structure under preparation.
...
it's comparison with numerically evaluated parameters. Finally, we
...
structures.\notaL{Tenemos referencias para afirmar esto?}
\notaV{NOT THAT I KNOW, so I changed the expression has been changed}
 Thus, we believe a
...
\notaL{¿De qué se trata esta referencia que pusiste
  aquí: \cite{kratzer2019basics}?}, \notaC{Lo que quiero con este paper
es resaltar los Conceptos básicos de la cristalografía,
grupo de puntos cristalográficos, la red recíproca y algunos relaciones de la
zona de Brillouin.}
...
\begin{figure}
  ...
  \caption{Schematic experimental set-up for
    ...
    illustrating eight regions $1\ldots8$ of decreasing porosity,
...
electrical contact to a silver plate\notaC{ plata.}\notaL{Porqué
vivechna dice silver/copper? De qué era: latón, plata, cobre, una
aleación de cobre y plata? Era un alambre o una placa?}
\notaV{CRISTIAN :  POR FAVOR COLOCAS lo que usaste.}
...
UV-Vis-NIR spectrophotometer in its data collection absolute
reflectance mode, using a rectangular spot size of
$0.7\text{mm}\times2.0\text{mm}$, a slit width of $0.6\text{mm}$ and
a wavelength range from $1400\text{nm}$ to
$300\text{nm}$.\notaL{Vivechna: puedes checar si así se reportan estos parámetros?}
\notaV{CHANGED}
...
an air environment  (0), the PS film (1) and the c-Si substrate (2),
...
The theoretical reflectance could as well be calculated using
...
\notaV{ acknowledges support from CONACyT Basic Sciences project A-S1 30393,
PRODEP and ICF.}

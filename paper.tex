...
\caption{\notaL{reordené figura y rehice} Experimental set-up for
      ...
      rectangular electrochemical cell. We indicate the Si wafer (dark
      ...
      (yellow) and the current source. We indicate some geometrical
      parameters of the arrangement $x0$, $z0$, $a$ and $c$
...
rectangular prism on the bottom of which we place a Si which makes an

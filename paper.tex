...
\begin{table}
  ...
  \begin{tabular}{rrr}
    ...
    1.6 & 1.46 & 0.1666\\
  \end{tabular}
  \caption{Normalized current density expected at different positions on
    different samples.}
  \label{t:xj}
\end{table}
...
We measured the reflectance spectra of sample $G_3$ at the positions
indicated in Fig. \ref{fig:SI3}. The results are shown in
Fig. \ref{fig:R20}.
...
obtained the etching rate $v=d/t$. Notice that the fit is reasonably
good. The contrast of the reflectance in the experiment is smaller
than the fit. We believe this is due to the finite width
\notaL{beams width=?} of the illuminating beam of our
spectrometer. Thus, as our GRIN sample is not homogeneous, the
experimental results show an average over regions with slightly
different porosities and thicknesses, averaging out the interference
maxima and minima. This is most notable for the thicker regions
towards the left side of Fig. \ref{fig:SI3} and for smaller
wavelengths. Similar remarks apply to the fits to the reflectance
spectra of the other samples, incorporated in our supplemental
material (Figs. \ref{fig:R5} and \ref{figR10}).
...
\begin{tabular}{lrrrrrr}
  Sample & current &  density \(j\) & porosity &
  thickness & scale \(s\)& etching rate\\
       & $I$ (mA)      & $j$ ($\text{mA}/\text{cm}^2$) & $p$
       & $d$ ($\mu\text{m}$) & $s$ & $v$ (nm/s)\\
\hline
$G_1$ & 5  & 3.609 & 0.4943 & 0.3402 & 0.8493&  1.3608 \\
      &    & 3.361 & 0.5713 & 0.3895 & 0.9789&  1.558  \\
      &    & 2.884 & 0.5657 & 0.3312 & 0.9569&  1.3248 \\
      &    & 2.322 & 0.5555 & 0.2732 & 0.9536&  1.0928 \\
      &    & 1.799 & 0.5592 & 0.2236 & 0.9951&  0.8944 \\
      &    & 1.374 & 0.5557 & 0.1886 & 0.9729&  0.7544 \\
      &    & 1.056 & 0.5491 & 0.1512 & 0.9606&  0.6048 \\
      &    & 0.833 & 0.5519 & 0.1238 & 0.9897&  0.4952 \\
$G_2$ & 10 & 7.219 & 0.5910 & 0.6347 & 0.8559&  2.5388 \\
      &    & 6.723 & 0.6437 & 0.6934 & 0.9914&  2.7736 \\
      &    & 5.769 & 0.6383 & 0.5907 & 0.9523&  2.3628 \\
      &    & 4.645 & 0.6265 & 0.5327 & 0.9798&  2.1308 \\
      &    & 3.599 & 0.5991 & 0.4587 & 0.9389&  1.8348 \\
      &    & 2.749 & 0.5902 & 0.4044 & 0.9449&  1.6176 \\
      &    & 2.112 & 0.5753 & 0.3378 & 0.9361&  1.3512 \\
      &    & 1.666 & 0.5711 & 0.2958 & 0.9481&  1.1832 \\
$G_3$ & 20 & 14.438& 0.6860 & 1.2044 & 1.1491&  4.8176 \\
      &    & 13.44 & 0.7129 & 1.1931 & 1.0767&  4.7724 \\
      &    &11.538 & 0.7031 & 1.0443 & 1.0588&  4.1772 \\
      &    & 9.29  & 0.6258 & 0.7516 & 1.0063&  3.0064 \\
      &    & 7.198 & 0.6247 & 0.5380 & 1.0104&  2.152  \\
      &    & 5.498 & 0.5927 & 0.4387 & 0.9625&  1.7548 \\
      &    & 4.224 & 0.5844 & 0.3633 & 0.9625&  1.4532 \\
      &    & 3.332 & 0.5909 & 0.3392 & 1.0112&  1.3568 \\
\end{tabular}
\caption{\label{t:jpdv}
  Names of data files, current, current density and fitted parameters:
  porosity, thickness and scale factor.}
\end{table}

\ifinclude
We obtained $p_{1A}=0.44$, $p_{1B}=0.42$, and
...
\begin{figure}
  ...
  \caption{(a) Etching rate $v$ and (b) porosity $p$ as a function of the
    ...
    law fits, yielding $v=0.68j_\perp^{0.69}$ and
    $p=0.33j_\perp^0.21$, \notaC{cambie las expresiones $v=0.53j_\perp^{0.79}$
    and $p=0.3j_\perp^0.24$}
    with corresponding correlation coefficients
      $r_v^2=0.951$ and $r_p^2=0.989$ \notaC{ tambien cambie $r_v^2=0.993$
      and $r_p^2=0.0.847$ }(here $v$ is in nm/s, $p$ is
...
\begin{equation}
  \label{eq:etch}
  v=0.68j_\perp^{0.69} \notaC{cambie v=0.53j_\perp^{0.79}}
\end{equation}
and
\begin{equation}
  \label{eq:poros}
  p=0.33j_\perp^{0.21}, \notaC{cambie p=0.3j_\perp^{0.24}}
\end{equation}
where $v$ is
expressed in nm/s, $p$ is dimensionless and $j_\perp$ is expressed as
mA/cm$^2$. The corresponding correlation coefficients are $r_v^2=0.951$
and $r_p^2=0.847$. \notaC{cambie $r_v^2=0.993$
and $r_p^2=0.989$.}
...
\begin{figure}
  ...
  \caption{Reflectance spectra at different positions
    on sample $G_1$ (shown in Fig. \ref{fig:SI3}), where
    $x'_n=0.2-1.6\,\text{cm}$ and $y=0.74\,\text{cm}$. We show
  experimental results and results fitted through
  equations~\eqref{Eq:ECMR} and \eqref{Eq:Brugg}}.
  \label{fig:R5}

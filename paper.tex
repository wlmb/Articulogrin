...
\author[1]{C. A. Ospina-Delacruz}
\author[2,3]{V. Agarwal}
\author[3]{W. L. Mochán}
...
spectroscopy, and related them
to their local porosity and thickness which, together with our model, were then used to obtain
the $p$ vs. $j$ and $v$ vs. $j$ calibration curves.  The dependence of
porosity and thickness with position was corroborated through scanning electron microscopy. We
compared the calibration curves for different samples. Thus, from
...
\notaC{\subsection{Morphological studies}}
\notaC{The morphologies of the etched porous layers (plan-view and cross-sectional) was observed using 
(SEM) scanning electron microscopy (Hitachi SU1510  High Technologies Canada, 
Inc., Toronto, Canada), the thickness  and porosity  of each fabricated  film was measured.}
\notaL{Insert a paragraph explaining something about how the
  micrographs were obtained. Choose an appropriate title for the
  subsection. Include the definition of the acronym SEM}
...
IN111119. VA acknowledges support from CONACyT Basic Sciences project
A-S1 30393 and from PRODEP, and is grateful to ICF where she spent a
sabatical. CAOD is grateful for a scholarship from CONACyT.

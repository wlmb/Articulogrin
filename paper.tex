...
\begin{figure}
  ...
  \caption{Side view of the electrolytic cell (light blue)
    ...
    charges $q_0$ and another four charges $-q_0$.}
  \label{fig:sideview}
\end{figure}
...
$2a\times2b\times4c$ with a basis of 16 point charges arranged in
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{Images/celd1}
  \caption{Diagram shows that there is a positive (real) plane $
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{Images/DE1}
\caption{Schematic of the experimental set-up for
...
\subsection{Simulation of  the current density}
...
\begin{figure}
  ...
  \caption{Simulation to calculate the current density in
...
\begin{figure}
  ...
  \caption{a) Silicon sample attacked with an electrolytic

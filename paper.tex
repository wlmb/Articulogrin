...
Layered systems with a lateral gradient in their refractive indices
and thicknesses may be employed for the development of a variety of
optical devices and
applications. They may be fabricated of porous silicon (PS) through a
position dependent electrochemical process. Thus, the possibility of
predicting the local current density $j$ and the co rresponding
porosity $p$
and etching rate $v$ would be desirable for a systematic design of these
...
some graded single layer PS samples, measured their optical properties with
